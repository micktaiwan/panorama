...
export const SearchBar = ({ value, onChange, onSearch, resultsCount = 0, placeholder = 'Search (semantic)…', autoFocus = false, cached = false, armSelectFirst = false, onSelectFirst = null, cacheSize = 0, loading = false }) => {
  return (
