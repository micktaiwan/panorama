...
export const Help = () => {
  return (
    <div className="help">
      ...
      <p className="muted" style={{ marginBottom: '16px' }}>Open this page: <span className="bold">⌘G</span> / <span className="bold">Ctrl+G</span> then <span className="bold">H</span>, or via the footer link.</p>
      <ul className="helpList">
        ...
        <ul>
          <li>
            ...
            <ul>
              <li className="muted">Tabs: Search · Create Task · Create Note · Create Alarm</li>
              <li>
              ...
              <li>
                <span className="bold">Create Alarm</span>
                <ul>
                  <li><span className="bold">Enter</span> — create the alarm</li>
                </ul>
              </li>
            </ul>
          </li>
          ...
          <li><span className="bold">New Note Session</span> — <span className="bold">⌘N</span> (macOS) / <span className="bold">Ctrl+N</span> (Windows/Linux) — creates a note session (linked to current project if on a project page)</li>
          ...
          <li><span className="bold">Quit</span> — <span className="bold">⌘Q</span> (macOS) / <span className="bold">Ctrl+Q</span> (Windows/Linux) — shows quit confirmation</li>
        </ul>
        ...
        <li className="headingSection headingFeatures"><span className="bold">Emails</span></li>
        <ul>
          <li><span className="bold">F5</span> / <span className="bold">Ctrl+R</span> — Refresh emails</li>
          <li><span className="bold">↑/↓</span> — Navigate between emails</li>
          <li><span className="bold">A</span> — Archive current email (Gmail)</li>
          <li><span className="bold">D</span> — Delete current email (Gmail)</li>
          <li><span className="bold">Z</span> — Archive locally (hide from view)</li>
        </ul>
        <li className="headingSection headingFeatures"><span className="bold">Claude Code</span></li>
        <ul>
          <li><span className="bold">⌘D / Ctrl+D</span> — New Claude session (split panel)</li>
          <li><span className="bold">⌘W / Ctrl+W</span> — Close active session</li>
          <li><span className="bold">Tab</span> (in input) — Cycle permission mode (Default → Plan → Accept Edits → Don't Ask → Bypass)</li>
          <li><span className="bold">Esc</span> (while running) — Stop execution</li>
          <li><span className="bold">Enter</span> — Send message; <span className="bold">Shift+Enter</span> — new line</li>
          <li><span className="bold">/</span> — Show slash command suggestions; <span className="bold">↑/↓</span> navigate; <span className="bold">Enter</span> or <span className="bold">Tab</span> selects</li>
        </ul>
        <li className="headingSection headingFeatures"><span className="bold">Special Features</span></li>
        <ul>
          <li><span className="bold">AI Chat</span> — <span className="bold">⌘L</span> toggle open/close; <span className="bold">⌘⇧L</span> cycle mode (floating → docked → windowed)</li>
          ...
          <li><span className="bold">Focus mode</span> — <span className="bold">⌘⇧F</span> (macOS) / <span className="bold">Ctrl+Shift+F</span> (Windows/Linux) — hides title, navigation and footer; panel fills the screen. Press again to exit.</li>
        </ul>
      </ul>
    </div>
  );
