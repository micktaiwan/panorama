...
Meteor.startup(async () => {
  ...
  const { CommitsCollection, BranchClassificationsCollection } = await import('/imports/api/staffing/gitCollections');
  ...
  CommitsCollection.rawCollection().createIndex({ userId: 1, opportunityId: 1, committedAt: -1 }).catch(() => {});
